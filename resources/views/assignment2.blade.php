...
<p style="background: lightblue; padding: 20px; margin-top: 20px;"><strong>{{ $question->text }}</strong><br><br>Leg het resultaat vast op foto of film en laat dat zien aan de jury om hiervoor punten te krijgen!</p>
